...
class Employee1
{
    ...
    String department;
    int salary;
    Employee1(int id, String name, String department, int salary)
    {
        this.id = id;
        this.name = name;
...
class Sortbydepartment implements Comparator
{
 ...
 class TreeSetExample {
         public static void main(String[] args)
    {
        ...
        {
            case 1:
                TreeSet<Employee1> s1 = new TreeSet<Employee1>(new Sortbyid());
                s1.add(t1);
                s1.add(t2);
                s1.add(t3);
                s1.add(t4);
                ...
                break;
            case 2:
                TreeSet<Employee1> s2 = new TreeSet <Employee1>(new Sortbysalary());
                s2.add(t1);
                s2.add(t2);
                s2.add(t3);
                s2.add(t4);
